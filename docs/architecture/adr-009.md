# ADR 009: Permissioned addresses in Merlin
...
- completely remove (rollback) and be replaced by the circuit breaker
  (PR to rollback: https://github.com/merlins-labs/merlin/pull/795 and https://github.com/crypto-org-chain/gravity-bridge/pull/96)
