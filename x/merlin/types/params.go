...
var (
	...
	// KeyMerlinAdmin is store's key for the admin address
	KeyMerlinAdmin = []byte("MerlinAdmin")
...
// NewParams creates a new parameter configuration for the merlin module
func NewParams(ibcCroDenom string, ibcTimeout uint64, merlinAdmin string, enableAutoDeployment bool) Params {
	return Params{
		IbcCroDenom:          ibcCroDenom,
		IbcTimeout:           ibcTimeout,
		MerlinAdmin:          merlinAdmin,
		EnableAutoDeployment: enableAutoDeployment,
	}
}

// DefaultParams is the default parameter configuration for the merlin module
...
// Validate all merlin module parameters
func (p Params) Validate() error {
	...
	if len(p.MerlinAdmin) > 0 {
		if _, err := sdk.AccAddressFromBech32(p.MerlinAdmin); err != nil {
			return err
		}
	}
	return nil
...
func (p *Params) ParamSetPairs() paramtypes.ParamSetPairs {
	return paramtypes.ParamSetPairs{
		...
		paramtypes.NewParamSetPair(KeyMerlinAdmin, &p.MerlinAdmin, validateIsAddress),
