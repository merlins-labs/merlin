...
func init() {
	proto.RegisterType((*ContractByDenomRequest)(nil), "merlin.ContractByDenomRequest")
	proto.RegisterType((*ContractByDenomResponse)(nil), "merlin.ContractByDenomResponse")
	proto.RegisterType((*DenomByContractRequest)(nil), "merlin.DenomByContractRequest")
	proto.RegisterType((*DenomByContractResponse)(nil), "merlin.DenomByContractResponse")
	proto.RegisterType((*ReplayBlockRequest)(nil), "merlin.ReplayBlockRequest")
	proto.RegisterType((*ReplayBlockResponse)(nil), "merlin.ReplayBlockResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "merlin.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "merlin.QueryParamsResponse")
	proto.RegisterType((*QueryPermissionsRequest)(nil), "merlin.QueryPermissionsRequest")
	proto.RegisterType((*QueryPermissionsResponse)(nil), "merlin.QueryPermissionsResponse")
}

func init() { proto.RegisterFile("merlin/query.proto", fileDescriptor_d4ed0fd688c48372) }
...
func (c *queryClient) ContractByDenom(ctx context.Context, in *ContractByDenomRequest, opts ...grpc.CallOption) (*ContractByDenomResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.Query/ContractByDenom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DenomByContract(ctx context.Context, in *DenomByContractRequest, opts ...grpc.CallOption) (*DenomByContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.Query/DenomByContract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ReplayBlock(ctx context.Context, in *ReplayBlockRequest, opts ...grpc.CallOption) (*ReplayBlockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.Query/ReplayBlock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Permissions(ctx context.Context, in *QueryPermissionsRequest, opts ...grpc.CallOption) (*QueryPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/merlin.Query/Permissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ContractByDenom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.Query/ContractByDenom",
	}
...
func _Query_DenomByContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.Query/DenomByContract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ReplayBlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.Query/ReplayBlock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Permissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/merlin.Query/Permissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
