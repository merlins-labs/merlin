...
func Test_validateIsAddress(t *testing.T) {
	...
	tests := []struct {
		...
		{"invalid bech32 prefix", args{"tdid:fury:iaa12luku6uxehhak02py4rcz65zu0swh7wjsrw0pp"}, true},
		{"correct bech32 address", args{"did:fury:iaa12luku6uxehhak02py4rcz65zu0swh7wjsrw0pp"}, false},
	}
	for _, tt := range tests {
		tt := tt
		t.Run(tt.name, func(t *testing.T) {
