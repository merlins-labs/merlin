...
func GetQueryCmd(queryRoute string) *cobra.Command {
	// Group merlin queries under a subcommand
	cmd := &cobra.Command{
...
func QueryParamsCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "params",
		Short: "Query the current merlin parameters",
		Args:  cobra.NoArgs,
		Long: strings.TrimSpace(`Query the current merlin parameters:

$ <appd> query merlin params
`),
