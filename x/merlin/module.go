...
// RandomizedParams creates randomized merlin param changes for the simulator.
func (AppModule) RandomizedParams(r *rand.Rand) []simtypes.ParamChange {
	return nil
}

// RegisterStoreDecoder registers a decoder for merlin module's types
...
// GenerateGenesisState creates a randomized GenState of the merlin module.
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	simulation.RandomizedGenState(simState)
}

// WeightedOperations returns the all the merlin module operations with their respective weights.
